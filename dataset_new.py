...
class ListDataset(Dataset):
    def __init__(self, list_path, num_classes=20, anchor_path='./config/yolo_anchors.txt', img_size=416,):
    ...
    def __getitem__(self, index):
        ...
        y_true, anchor_iou = self.preprocess_true_box(labels)
    ...
    def preprocess_true_box(self, true_boxes):
        ...
        y_true = [np.zeros((self.grid_shapes[l][0], self.grid_shapes[l][1], len(self.anchor_mask[l]), 9),
        ...
        for t, n in enumerate(best_anchor):
            for l in range(self.num_layers):
                if n in self.anchor_mask[l]:
                    ...
                    # print(anchor_iou)
                    # print(self.anchor_mask[l])
                    # print(anchor_iou[t, self.anchor_mask[l]])
                    ...
                    y_true[l][j,i,k,0:4] = true_boxes[t,1:5]
                    y_true[l][j,i,k,4] = 1
                    y_true[l][j,i,k,5] = c
                    y_true[l][j,i,k,6:] = anchor_iou[t, self.anchor_mask[l]] > 0.5

        return y_true, anchor_iou
